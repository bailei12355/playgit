...
<head>
    ...
    <link rel="stylesheet" media="all" href="/app/item/blog/Public/Css/reading-bc4422e046bfdc9835cfcddb0c2de55d.css" />
  	...
  	<script src="/app/item/blog/Public/jquery.min.js"></script>
  	<script src="/app/item/blog/Public/bootstrap.min.js"></script>
...
<body class="output no-fluid zh cn reader-day-mode reader-font2" data-js-module="" data-locale="zh-CN">
	<div class="navbar navbar-jianshu shrink">
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
				...
				<li>
					<a href="/collections"> <i class="fa fa-th"></i>
						专题
					</a>
				</li>
				<li>
	...
	<div class="navbar-user">
		<a class="login" data-signup-link="true" data-toggle="modal" href="<?php echo U('Home/signup/index');?>"> <i class="fa fa-user"></i>
			注册
		</a>
		<a class="login" data-signin-link="true" data-toggle="modal" href="<?php echo U('Home/login/index');?>"> <i class="fa fa-sign-in"></i>
			登录
		</a>
	...
	<div class="container">
		...
		<div class="login-page">
			<div class="logo">
				<img src="/app/item/blog/Public/Picture/img_logo-25ff4bee2e56411470b83c636a7a0dad.png" alt="Img logo" />	
			</div>
			<h4 class="title">
				<span>
					<a class="" data-pjax="true" href="<?php echo U('home/login/index');?>
                ">登录</a> <b>·</b>
					<a class="active" data-pjax="true" href="<?php echo U('/Home/signup/index');?>">注册</a>
				</span>
			</h4>
			<div id="pjax-container">

				<div class="sign-in">
					<form  class="form-horizontal" data-js-module="sign-in" action="<?php echo U('home/signup/insert');?>" accept-charset="UTF-8" method="post">
						<div class="input-prepend domestic " id="utab">
							<span class="add-on"> <i class="fa fa-user"></i>
							</span>
							<input type="text" onblur="checkUser()" name="uname" id="utab" value="" class="span2" placeholder="用户名" />	
						</div>
						...
						<div class="input-prepend domestic ">
							...
							<input type="text" name="email" id="sign_in_name" value="" class="span2" placeholder="电子邮件" />	
						</div>
						...
						<div><img style="cursor:pointer" onclick="this.src=this.src+'?i='+Math.random()" src="<?php echo U('signup/Verify');?>"></div>
						<br>
