...
<div class="navbar navbar-jianshu shrink">
    <div class="dropdown">
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
            <li><a href="<?php echo U('Home/index/index');?>"><i class="fa fa-home"></i> 首页</a></li>
            <li><a href="<?php echo U('Home/Category/index');?>"><i class="fa fa-th"></i> 专题</a></li>
    ...
    <div class="user-aside span3">
        <div class="people">
            <div class="basic-info">
                <div class="avatar">
                    <img src="/blogs/Uploads/touxiang/<?php echo ($date['head_img']); ?>" alt="100" />
                </div>
