...
<head>
    ...
    <link rel="stylesheet" media="all" href="/app/item/blog/Public/Css/my.css" />
...
<div class="row-fluid ">
    ...
    <div class="user-aside span3">
        <div class="people">
            <div class="basic-info">
                <div class="avatar">
                    <img src="/app/item/blog/Uploads/touxiang/<?php echo ($date['head_img']); ?>" alt="" />
                </div>
                <form action="<?php echo U('/Home/touxiang/index');?>" enctype="multipart/form-data" method="post" >
    ...
    <div class="span9 offset3 recent-post">
        ...
        <div class="tab-content">
            <div id="list-container" class="tab-pane active kuan pull-left">    
                    ...
                    <li >
                        <div>
                            <p class="list-top">
                                ...
                                <form action="<?php echo U('/Home/xgzl/xgzl');?>" method="post" >
                                    <div class="form-group " id="row2">
                                        <label for="user" id="row2"><b>昵称:</b></label>
                                        <input type="text" name="nickname" class="form-control" id="user" placeholder="请输入昵称">
                                    </div>
                                    <input type="text" name="uid" class="form-control hidden" value="<?php echo ($_SESSION["home"]["uid"]); ?>">
                                    <div class="form-group" id="row2">
                                        <label for="repwd" id="row2">手机号码:</label>
                                        <input type="text" name="mobile" class="form-control" id="repwd" placeholder="请输入手机号码">
                                    </div>
                                    <div>
                                        <label for="xm" >性别:</label>
                                        <input type="radio" name="sex" value="1" checked />男
                                        <input type="radio" name="sex" value="0" />女
                                    </div>
                                    <br>
                                    <div class="form-group" id="row2">
                                        <label for="xm" id="row2">年龄:</label>
                                        <input type="text" name="age" maxlength='2' class="form-control" id="xm" placeholder="请输入年龄">
                                    </div>
