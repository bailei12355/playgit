...
<body>
<form class="form-group" action="<?php echo U('Admin/User/insert');?>" method="post">
    <table class="table table-bordered table-striped table-hover table-condensed">
        
        <tr>
            <th>用户名</th>
            <td>
                <input class="form-control modal-sm" type="text" name="uname">
            </td>
        </tr>
        <tr>
            <th>密码</th>
            <td>
                <input class="form-control modal-sm" type="text" name="pwd" >
            </td>
        </tr>
        <tr>
            <th>邮箱</th>
            <td>
                <input class="form-control modal-sm" type="text" name="email" >
            </td>
        </tr>
        <tr>
            <th>年龄</th>
            <td>
                <input class="form-control modal-sm" type="text" name="age" >
            </td>
        </tr>
        ...
        <tr>
            <th>性别</th>
            <td>
                <span class="inputword">男</span>
                <input class="icheck" type="radio" name="sex" value="1" checked="checked">
                &emsp;
                <span class="inputword">女</span>
                <input class="icheck" type="radio" name="sex" value="0">
            </td>
        </tr>
